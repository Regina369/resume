...
var header = {
  ...
  salary: '600 $ в місяць',
  address: 'Ivano-Frankivsk, Kolomyia',
}
...
router.get('/skills', function (req, res) {
  ...
  res.render('skills', {
    ...
    main: {
      ...
      hobbies: [
        { name: 'Kikboxing', isMain: true },
        { name: 'motorcycle', isMain: true },
        { name: 'Kikboxing', isMain: false },
      ],
    },
...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        { name: 'Ліцей', point: 10, isEnd: true },
        { name: 'ВПУ', point: 2, isEnd: true },
        { name: 'IT Brains', point: 0, isEnd: false },
      ],
      certificates: [
        { name: 'Масажист', id: 369 },
        { name: 'Тренер з йоги', id: 321 },
        { name: 'Зубний технік', id: 456 },
      ],
    },
          ...
          projects: [
            {
              ...
              awards: [
                {
                  name: 'Background verification - is feature that provides users to prove that they are real persons',
                },
                {
